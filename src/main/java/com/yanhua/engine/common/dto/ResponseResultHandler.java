 ...
 * 作者姓名 修改时间 版本号 描述
 */
package com.yanhua.engine.common.dto;

import com.yanhua.engine.common.exception.EngineException;
...
import static com.yanhua.engine.common.dto.ResponseResultInterceptor.RESPONSE_RESULT_ANN;
...
//                return JSON.toJSONString(new ResponseEntity<>(bo, HttpStatus.OK));
                return body;
            }
