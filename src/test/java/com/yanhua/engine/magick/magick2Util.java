...
// * 〈功能简述〉<br>
// * 〈magick的核心api工具类〉
// *  经过测试ImageMagick7.x版本不支持，命令貌似换了，安装之后文件都不一样了
// *  <p>
// * @author Emiya
// * @create 2020/8/3 14:54
// * @version 1.0.0
// */
//@Component
//public class magick2Util {
//
//
//
//    /**
...
//     * 水印图片路径
//     */
//    private static String watermarkImagePath = "C:\\Users\\49468\\Desktop\\logoo2.png";
//
//    /**
//     * 水印图片
//     */
...
//        switch (command) {
//            case CONVERT:
//                cmd = new ConvertCmd(useGraphicsMagickPath);
//                break;
//            case IDENTIFY:
//                cmd = new IdentifyCmd(useGraphicsMagickPath);
//                break;
//            case COMPOSITE:
//                cmd = new CompositeCmd(useGraphicsMagickPath);
//                break;
//        }
//        if (System.getProperty("os.name").toLowerCase().contains("win")) {
//            cmd.setSearchPath(useGraphicsMagickPath ? graphicsMagickPath : imageMagickPath);
//        }
//        return cmd;
//    }
//
